                ...
                <div class="box-one flex flex-row flex-wrap">
                    <article class="flex-shrink max-w-full w-full sm:w-1/2">
                        <div class="relative hover-img max-h-48 overflow-hidden">
                            <a href="#">
                                <img class="max-w-full w-full mx-auto h-auto" src="{{ asset('images/dummy/img2.jpg') }}"
                                    alt="Image description">
                            </a>
                    ...
                    <article class="flex-shrink max-w-full w-full sm:w-1/2">
                        <div class="relative hover-img max-h-48 overflow-hidden">
                            <a href="#">
                                <img class="max-w-full w-full mx-auto h-auto" src="{{ asset('images/dummy/img3.jpg') }}"
                                    alt="Image description">
                            </a>
                            <div class="absolute px-4 pt-7 pb-4 bottom-0 w-full bg-gradient-cover">
                                <a href="#">
                    ...
                    <article class="flex-shrink max-w-full w-full sm:w-1/2">
                        <div class="relative hover-img max-h-48 overflow-hidden">
                            <a href="#">
                                <img class="max-w-full w-full mx-auto h-auto" src="{{ asset('images/dummy/img4.jpg') }}"
                                    alt="Image description">
                            </a>
                            <div class="absolute px-4 pt-7 pb-4 bottom-0 w-full bg-gradient-cover">
                                <a href="#">
                    ...
                    <div class="flex flex-row flex-wrap -mx-3">
                        <div
                            ...
                            <div class="flex flex-row sm:block hover-img">
                                <a href="">
                                    <img class="max-w-full w-full mx-auto" src="{{ asset('images/dummy/img6.jpg') }}"
                                        alt="alt
                                        title">
                                </a>
                        ...
                        <div
                            ...
                            <div class="flex flex-row sm:block hover-img">
                                <a href="">
                                    <img class="max-w-full w-full mx-auto" src="{{ asset('images/dummy/img7.jpg') }}"
                                        alt="alt
                                        title">
                                </a>
                                <div class="py-0 sm:py-3 pl-3 sm:pl-0">
                        ...
                        <div
                            ...
                            <div class="flex flex-row sm:block hover-img">
                                <a href="">
                                    <img class="max-w-full w-full mx-auto" src="{{ asset('images/dummy/img8.jpg') }}"
                                        alt="alt
                                        title">
                                </a>
                                <div class="py-0 sm:py-3 pl-3 sm:pl-0">
                        ...
                        <div
                            ...
                            <div class="flex flex-row sm:block hover-img">
                                <a href="">
                                    <img class="max-w-full w-full mx-auto" src="{{ asset('images/dummy/img9.jpg') }}"
                                        alt="alt
                                        title">
                                </a>
                                <div class="py-0 sm:py-3 pl-3 sm:pl-0">
                        ...
                        <div
                            ...
                            <div class="flex flex-row sm:block hover-img">
                                <a href="">
                                    <img class="max-w-full w-full mx-auto" src="{{ asset('images/dummy/img10.jpg') }}"
                                        alt="alt title">
                                </a>
                                <div class="py-0 sm:py-3 pl-3 sm:pl-0">
                                    <h3 class="text-lg font-bold leading-tight mb-2">
