...
<body class="min-h-screen bg-white dark:bg-zinc-800">
    ...
    <div class="bg-zinc-50 py-3 h-12 w-full z-50 px-6">
        <div class="px-6 max-w-7xl mx-auto grid grid-cols-4 grid-rows-1">
            Top bar
        </div>
    </div>
    <div class="bg-blue-50 py-3 h-24 w-full  z-50 px-6 max-w-7xl mx-auto grid grid-cols-4 grid-rows-1">
        <div class="col-span-1 bg-yellow-500 flex items-center">
            <a href="#" class=" max-h-full flex items-center">
                <img src="{{ asset('images/logo.png') }}" alt="" class="block max-h-full h-16">
                <span class="ml-3 text-4xl">bullerfnis</span>
            </a>
        </div>
    </div>
                ...
                <flux:menu>
                    ...
                    <form method="POST" action="{{ route('logout') }}" x-data>
                        ...
                        <flux:menu.item icon="arrow-right-start-on-rectangle" type="submit"
                            href="{{ route('logout') }}" @click.prevent="$root.submit();">Logout</flux:menu.item>
                    </form>
